...
const DiamondDivider = () => (
  <div className="flex items-center justify-center gap-3 my-3">
    <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-[#051711]/60" />
    ...
    <div className="h-[1px] w-12 bg-gradient-to-l from-transparent to-[#051711]/60" />
  </div>
);
    ...
    <div className="min-h-screen bg-[#051711] font-sans">
      ...
      <section className="text-center pt-16 pb-8 px-6">
        ...
        >
          ...
          <Link
            href="/work-process"
            className="text-[#DCEFE8]/60 underline underline-offset-2 hover:text-[#DCEFE8] transition-colors text-xs"
          >
            How it works
          </Link>
        </motion.p>
      ...
      >
        <div className="grid md:grid-cols-2 overflow-hidden rounded-sm border border-[##051711]/40 shadow-[0_20px_60px_-10px_rgba(0,0,0,0.6)]">
          {/* Left: Image */}
          <div className="relative min-h-[420px] md:min-h-0">
            ...
            {/* Bottom fade */}
            <div className="absolute inset-0 bg-gradient-to-t from-[#051711]/60 via-transparent to-transparent" />
          </div>

          {/* Right: Form */}
          <div className="bg-[#051711] border-l border-[#051711]/30 px-7 py-8">
            <div className="flex items-center gap-4 mb-5">
              <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent to-[#051711]/40" />
              <p className="gradient-heading text-2xl md:text-2xl leading-[1.1]">
                Get In Touch
              </p>
              <div className="h-[1px] flex-1 bg-gradient-to-l from-transparent to-[#051711]/40" />
            </div>
            <p className="text-white/40 text-xs leading-relaxed mb-6">
              Fill out the form below to schedule a free consultation or ask any
              questions.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="gradient-heading text-l leading-[1.1] w-full text-center py-3 border border-[#D4AF37] hover:bg-[#D4AF37]/10 transition-colors duration-300"
              >
                {loading
                  ? "Sending..."
                  : sent
      ...
      <motion.section
        ...
        className="max-w-5xl mx-auto px-4 md:px-8 mt-8 grid grid-cols-1 md:grid-cols-3 gap-4"
      >
        {/* Call */}
        <div
          className="border border-[#D4AF37]/50 px-6 py-8 text-center space-y-2 rounded-sm"
          style={{
        ...
        >
          <div className="flex justify-center mb-4">
            <div className="w-10 h-10 rounded-full border border-[#D4AF37]/40 flex items-center justify-center">
              <Phone size={15} className="text-[#D4AF37]" strokeWidth={1.5} />
            </div>
          </div>
          <p className="text-[11px] tracking-[0.35em] uppercase text-[#D4AF37] font-medium">
            Call Us
          </p>
          <a
            href="tel:9113054788"
        ...
        >
          <div className="flex justify-center mb-4">
            <div className="w-10 h-10 rounded-full border border-[#D4AF37]/40 flex items-center justify-center">
              <MapPin size={15} className="text-[#D4AF37]" strokeWidth={1.5} />
            </div>
          </div>
          <p className="text-[11px] tracking-[0.35em] uppercase text-[#D4AF37] font-medium">
            Visit Us
        ...
        >
          <div className="flex justify-center mb-4">
            <div className="w-10 h-10 rounded-full border border-[#D4AF37]/40 flex items-center justify-center">
              <Mail size={15} className="text-[#D4AF37]" strokeWidth={1.5} />
            </div>
          </div>
          <p className="text-[11px] tracking-[0.35em] uppercase text-[#D4AF37] font-medium">
            Email Us
          ...
          <a
            href="mailto:info@thegrandiose.in"
            className="block text-white/80 text-sm hover:text-[#D4AF37] transition-colors break-all"
          >
            info@thegrandiose.in
          </a>
          <p className="text-white/40 text-[11px]">
            Reach out via email and we'll get back to you within 24 hours.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="relative overflow-hidden rounded-sm border border-[##051711]/40 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.5)]">
          <iframe
          ...
          <div className="absolute bottom-4 left-1/2 -translate-x-1/2">
            <a
              ...
              className="inline-flex items-center gap-2 bg-[#051711]/90 border border-[#051711]/40 text-[#DCEFE8] text-[11px] tracking-[0.3em] uppercase px-6 py-3 hover:bg-[#051711] hover:text-[#DCEFE8] transition-all duration-300 shadow-lg backdrop-blur-sm"
            >
              <MapPin size={13} />
              Get Directions
            </a>
